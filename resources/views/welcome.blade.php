...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-sans">
        <!-- FONDO CON IMAGEN (forzado con !important) -->
        <div class="min-h-screen flex flex-col items-center justify-center" style="background-image: url('{{ asset('images/images.jpg') }}') !important; background-size: cover !important; background-position: center !important; background-repeat: no-repeat !important; background-color: #e5e7eb;">
            
            <!-- Contenedor principal centrado -->
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl flex flex-col items-center justify-center min-h-screen">
                
                <!-- Logo (centrado) -->
                <div class="mb-8">
                    <svg class="h-16 w-auto text-white lg:h-20 lg:text-[#FF2D20]" viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg">
