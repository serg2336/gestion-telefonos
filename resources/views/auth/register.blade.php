                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4" x-data="{ password: '' }">
                        ...
                        <div class="mt-2 space-y-1 text-sm">
                            <div :class="password.length >= 8 ? 'text-green-600' : 'text-red-500'">
                            ...
                            <div :class="/[^a-zA-Z0-9\u00f1\u00d1]/.test(password) ? 'text-green-600' : 'text-red-500'">
                                <span x-text="/[^a-zA-Z0-9\u00f1\u00d1]/.test(password) ? '✓' : '✗'"></span>
                                Al menos 1 símbolo
                            </div>
                        </div>
                    </div>
